...
You have to design & build the backend for the application and the ability for the users to register, search and review the products/brands.
...
https://github.com/azaylamba/mouthshut 
